...
const glutenFreeCheckbox = document.getElementById("filter-glutenFree");
const vegeCheckbox = document.getElementById("filter-vege");
const grogrosCheckbox = document.getElementById("filter-grogros");
...
form.addEventListener("submit", async (e) => {
  ...
  const newRecipe = {
    ...
    glutenFree: glutenFreeCheckbox?.checked || false,
    vege: vegeCheckbox?.checked || false,
    grogros: grogrosCheckbox?.checked || false
  };
...
glutenFreeCheckbox?.addEventListener("change", () => {
  filterGlutenFree = glutenFreeCheckbox.checked;
  currentPage = 1;
  applyFiltersAndRender();
});
vegeCheckbox?.addEventListener("change", () => {
  filterVege = vegeCheckbox.checked;
  currentPage = 1;
  applyFiltersAndRender();
});
grogrosCheckbox?.addEventListener("change", () => {
  filterGrogros = grogrosCheckbox.checked;
  currentPage = 1;
  applyFiltersAndRender();
});
